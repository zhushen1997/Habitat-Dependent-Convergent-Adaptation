...
rownames(relative_taxonomy_mean_abundance) <- relative_taxonomy_mean_abundance$group
write.table(t(relative_taxonomy_mean_abundance), "taxonomy/3_relative_taxonomy_mean_abundance.tsv", row.names = TRUE, quote = FALSE)
...
ggsave("taxonomy/6_downstream_analysis/27_alluvial_plot.svg", plot = alluvial_plot, width = 3, height = 10, units = "cm", dpi = 300)
# ggsave("taxonomy/6_downstream_analysis/27_alluvial_plot.tiff", plot = alluvial_plot, width = 3, height = 10, units = "cm", dpi = 300) 
...
ggsave("taxonomy/6_downstream_analysis/28_ridges_alluvial_richness.svg", plot = ridges_alluvial_richness, width = 8, height = 15, units = "cm", dpi = 300)
# ggsave("taxonomy/6_downstream_analysis/28_ridges_alluvial_richness.tiff", plot = ridges_alluvial_richness, width = 8, height = 15, units = "cm", dpi = 300)
...
# LDA score plot
LDA_score <- read_excel("taxonomy/6_downstream_analysis/36_lefse_res.xlsx", sheet = 2)
...
relative_abundance_species_highlight <- as.data.frame(read_excel("taxonomy/5_Total/lefse_species/species/lefse_res.xlsx", sheet = 3))
...
ggsave("taxonomy/6_downstream_analysis/37_LDA_score_plot.svg", plot = LDA_plot, width = 10, height = 6, units = "cm", dpi = 300)
# ggsave("taxonomy/6_downstream_analysis/37_LDA_score_plot.tiff", plot = LDA_plot, width = 10, height = 6, units = "cm", dpi = 300)
...
ggsave("taxonomy/6_downstream_analysis/38_LDA_score_plot_legend.svg", plot = LDA_plot_legend, width = 30, height = 10, units = "cm", dpi = 300)
# ggsave("taxonomy/6_downstream_analysis/38_LDA_score_plot_legend.tiff", plot = LDA_plot_legend, width = 30, height = 10, units = "cm", dpi = 300)
...
ggsave("taxonomy/6_downstream_analysis/39_top5_species_box_plot.svg", plot = top5_species_box_plot, width = 14, height = 16, units = "cm", dpi = 300)
# ggsave("taxonomy/6_downstream_analysis/39_top5_species_box_plot.tiff", plot = top5_species_box_plot, width = 14, height = 16, units = "cm", dpi = 300)


### Ternary plot

# load genus-level taxonomy abundance table
genus <- read.table("taxonomy/6_downstream_analysis/40_ternary_plot_data.txt", sep = "\t", header = TRUE, row.names = 1) %>%  dplyr::select(-25) %>% t() %>% as.data.frame()
genus$group <- c(rep('Peri', 12), rep("Esin", 6), rep("Bger", 6))
regulation <- read.table("taxonomy/6_downstream_analysis/40_ternary_plot_data.txt", sep = "\t", header = TRUE, row.names = 1) %>% as.data.frame() %>%  dplyr::select(25) 
...
ggtern::ggsave("taxonomy/6_downstream_analysis/41_ternaryplot_genus.svg", plot = TernaryPlot, width = 8, height = 10, units = "cm", dpi = 300, device = svg)
# ggtern::ggsave("taxonomy/6_downstream_analysis/41_ternaryplot_genus.tiff", plot = TernaryPlot, width = 8, height = 10, units = "cm", dpi = 300)
