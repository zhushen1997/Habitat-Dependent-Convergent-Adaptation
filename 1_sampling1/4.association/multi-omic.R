...
p9 <- 
  ggplot(multi_omic, 
         aes(y = HostT_ko04150, x = HostT_ko04214) 
  )+
  geom_point(aes(fill = group, color = group),
             size = 1,
             shape = 21,
...
write.table(df, "../ko04150_hub_gene_correlation.txt",  sep = "\t", quote = F, row.names = F)
...
pathway_hub_gene_heatmap <-
  ko04150_hub_gene_exprission_heatmap %>%
  insert_bottom(ko00190_hub_gene_exprission_heatmap, height = 1.5) %>%
  insert_bottom(ko04122_hub_gene_exprission_heatmap, height = 0.13) %>%
  insert_bottom(ko04214_hub_gene_exprission_heatmap, height = 0.55)
