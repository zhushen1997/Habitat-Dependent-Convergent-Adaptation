...
pdf("2_downstream_analysis/9_transcriptome Hierarchical heatmap.pdf",
    width  = 20,
    height = 20)
...
# save image
ggsave("2_downstream_analysis/10_transcriptome_KEGG_pathway_enrich_pathway.svg", plot = up_pathway, width = 10, height = 4.5, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/10_transcriptome_KEGG_pathway_enrich_pathway.tiff", plot = up_pathway, width = 10, height = 4.5, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/11_transcriptome_KEGG_pathway_enrich_pathway_legend.svg", plot = up_pathway_combined_legend, width = 20, height = 10, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/11_transcriptome_KEGG_pathway_enrich_pathway_legend.tiff", plot = up_pathway_combined_legend, width = 20, height = 10, units = "cm", dpi = 300)
...
# save image
ggsave("2_downstream_analysis/12_transcriptome_KEGG_pathway_deplete_pathway.svg", plot = down_pathway, width = 10, height = 4.5, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/12_transcriptome_KEGG_pathway_deplete_pathway.tiff", plot = down_pathway, width = 10, height = 4.5, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/13_transcriptome_KEGG_pathway_deplete_pathway_legend.svg", plot = down_pathway_combined_legend, width = 20, height = 10, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/13_transcriptome_KEGG_pathway_deplete_pathway_legend.tiff", plot = down_pathway_combined_legend, width = 20, height = 10, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/14_pathway_percent_bar_plot.svg", plot = pathway_percent_bar_plot, width = 6, height = 12, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/14_pathway_percent_bar_plot.tiff", plot = pathway_percent_bar_plot, width = 6, height = 12, units = "cm", dpi = 300)
...
top10_enriched_pathway_p2 <- 
  ...
  annotate("rect", xmin = 10.5, xmax = 20.5, ymin = 0.5, ymax = 10.5, fill = NA, color = "red", linewidth = 0.25, lineend = "square")+
  scale_fill_gradient2(low = "lightblue", 
                       mid = "white", 
                       high = "#FF9898FF",
                       limit = c(min, max),
...
ggsave("2_downstream_analysis/15_top10_enriched_pathway.svg", plot = top10_enriched_pathway_p, width = 14, height = 9.5, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/15_top10_enriched_pathway.tiff", plot = top10_enriched_pathway_p, width = 14, height = 9.5, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/16_top10_depleted_pathway.svg", plot = top10_depleted_pathway_p, width = 14, height = 9.5, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/16_top10_depleted_pathway.tiff", plot = top10_depleted_pathway_p, width = 14, height = 9.5, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/17_top10_delepeted_enriched_pathway.svg", plot = top10_delepeted_enriched_pathway_plot, width = 20, height = 8, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/17_top10_delepeted_enriched_pathway.tiff", plot = top10_delepeted_enriched_pathway_plot, width = 20, height = 8, units = "cm", dpi = 300)

ggsave("2_downstream_analysis/17_top10_delepeted_enriched_pathway_0.svg", plot = top10_delepeted_enriched_pathway_plot_0, width = 7, height = 8, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/17_top10_delepeted_enriched_pathway_0.tiff", plot = top10_delepeted_enriched_pathway_plot_0, width = 7, height = 8, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/18_top10_delepeted_enriched_pathway_legend.svg", plot = top10_depleted_enriched_pathway_plot_legend, width = 20, height = 20, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/18_top10_delepeted_enriched_pathway_legend.tiff", plot = top10_depleted_enriched_pathway_plot_legend, width = 20, height = 20, units = "cm", dpi = 300)
...
pdf("2_downstream_analysis/19_Cross-validation.pdf",
    width  = 6,
    height = 6)
...
ggsave("2_downstream_analysis/20_cv_plot.svg", plot = cv_plot, width = 6, height = 6, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/20_cv_plot.tiff", plot = cv_plot, width = 6, height = 6, units = "cm", dpi = 300)
...
write_csv(coef.df, "2_downstream_analysis/21_Lasso_module_ranked_by_coef.csv")
...
ggsave("2_downstream_analysis/22_lasso_importance_rank_plot.svg", plot = lasso_importance_rank, width = 10, height = 4.5, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/22_lasso_importance_rank_plot.tiff", plot = lasso_importance_rank, width = 10, height = 4.5, units = "cm", dpi = 300)

ggsave("2_downstream_analysis/22_lasso_importance_rank_plot_0.svg", plot = lasso_importance_rank_0, width = 1, height = 4.5, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/22_lasso_importance_rank_plot_0.tiff", plot = lasso_importance_rank_0, width = 1, height = 4.5, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/23_quadrant_percent_pie_plot.svg", plot = quadrant_percent_pie_plot, width = 1, height = 1, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/23_quadrant_percent_pie_plot.tiff", plot = quadrant_percent_pie_plot, width = 1, height = 1, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/24_double_volcano_plot.svg", plot = double_volcano_plot, width = 6, height = 6, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/24_double_volcano_plot.tiff", plot = double_volcano_plot, width = 6, height = 6, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/25_venn_up.svg", plot = venn_up, width = 10, height = 5, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/25_venn_up.tiff", plot = venn_up, width = 10, height = 5, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/26_venn_down.svg", plot = venn_down, width = 10, height = 5, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/26_venn_down.tiff", plot = venn_down, width = 10, height = 5, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/27_regulation_stat.svg", plot = regulation_stat, width = 10, height = 10, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/27_regulation_stat.tiff", plot = regulation_stat, width = 10, height = 10, units = "cm", dpi = 300)
...
ggsave("2_downstream_analysis/28_merge_stat_plot.svg", plot = merge_stat_plot, width = 10, height = 10, units = "cm", dpi = 300)
ggsave("2_downstream_analysis/28_merge_stat_plot.tiff", plot = merge_stat_plot, width = 10, height = 10, units = "cm", dpi = 300)
